                ...
                <div class="card-body product-info">
                    <div class="row">
                        ...
                        <div class="col-7">
                            ...
                            <div class="price"><label>价格</label><em>￥</em><span>{{ $product->price }}/{{ $product->skus[3]->title }}</span></div>
                            ...
                            <div class="buttons">
                                @if($favored)
                                    <button class="btn btn-danger btn-disfavor">取消收藏 {{ $favorNum }}</button>
                                @else
                                    <button class="btn btn-success btn-favor">❤ 收藏  {{ $favorNum }}</button>
                                @endif
